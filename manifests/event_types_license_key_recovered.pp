# === class: brocadevtm::event_types_license_key_recovered
#
...
class brocadevtm::event_types_license_key_recovered (
  ...
  info ("Configuring event_types_license_key_recovered ${name}")
  ...
  if ( $purge ) {
    ...
    file_line { 'event_types/License%20Key%20Recovered':
      line => 'event_types/License%20Key%20Recovered',
