...
class brocadevtm::monitors_dns (
  ...
  $script__arguments     = '[{"name":"request_host","description":"The DNS monitor sends a DNS query to the DNS server running on the monitored node.<br>Hostname to look up in DNS:","value":""},{"name":"response_addr","description":"Address to expect in DNS response","value":""}]',
