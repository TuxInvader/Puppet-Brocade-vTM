...
# address.", "type"=>"string"}, "ipv6"=>{"description"=>"The MAC address to
# IPv6 address mapping of a router the software is connected to. The \"*\"
# (asterisk) in the key name is the MAC address, the value is the IP
# address.", "type"=>"string"}}
#
# [*java__classpath*]
