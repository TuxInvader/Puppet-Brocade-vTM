# === class: brocadevtm::event_types_trafficscript_error
#
...
class brocadevtm::event_types_trafficscript_error (
  ...
  info ("Configuring event_types_trafficscript_error ${name}")
  ...
  if ( $purge ) {
    ...
    file_line { 'event_types/TrafficScript%20Error':
      line => 'event_types/TrafficScript%20Error',
