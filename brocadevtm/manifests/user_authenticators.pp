...
#
# [*ldap__bind_dn*]
# Template to construct the bind DN (Distinguished Name) from the username. The string "%u" will be replaced by the username.  Examples: "%u@mycompany.local" for Active Directory or "cn=%u, dc=mycompany, dc=local" for both LDAP and Active Directory.
#
# [*ldap__dn_method*]
