# === Class: brocadevtm::event_types_Connection%20Failures
#
...
class brocadevtm::event_types_Connection%20Failures (
  ...
  info ("Configuring event_types_Connection%20Failures ${name}")
  vtmrest { "event_types/Connection%20Failures":
    ...
    content => template('brocadevtm/event_types_Connection%20Failures.erb'),
    internal => 'event_types_Connection%20Failures',
    debug => 0,
  }
}
