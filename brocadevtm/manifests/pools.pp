...
# Type:array, Details:{"node"=>{"description"=>"A node is a combination of an ip address and port", "type"=>"string"}, "priority"=>{"description"=>"The priority of the node, higher values signify higher priority. If a priority is not specified for a node it is assumed to be \"1\".", "type"=>"integer", "minimum"=>0}, "state"=>{"description"=>"The state of the pool, which can either be Active, Draining or Disabled", "type"=>"string", "enum"=>["active", "disabled", "draining"]}, "weight"=>{"description"=>"Weight for the node. The actual value in isolation does not matter: As long as it is a valid integer 1-100, the per-node weightings are calculated on the relative values between the nodes.", "type"=>"integer", "minimum"=>1, "maximum"=>100}, "source_ip"=>{"description"=>"The source address the Traffic Manager uses to connect to this node.", "type"=>"string"}}
#
# [*basic__note*]
...
#
# [*ssl__ssl_ciphers*]
# The SSL/TLS ciphers to allow for connections to a back-end node. Leaving this empty will make the pool use the globally configured ciphers, see configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!ssl3_ciphers"> "ssl!ssl3_ciphers"</a> in the Global Settings section of the System tab.  See there for how to specify SSL/TLS ciphers.
#
# [*ssl__ssl_support_ssl2*]
# Whether or not SSLv2 is enabled for this pool. Choosing the global setting means the value of the configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_ssl2"> "ssl!support_ssl2"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_ssl3*]
# Whether or not SSLv3 is enabled for this pool. Choosing the global setting means the value of the configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_ssl3"> "ssl!support_ssl3"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1*]
# Whether or not TLSv1.0 is enabled for this pool. Choosing the global setting means the value of the configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1"> "ssl!support_tls1"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1_1*]
# Whether or not TLSv1.1 is enabled for this pool. Choosing the global setting means the value of the configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1_1"> "ssl!support_tls1_1"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1_2*]
# Whether or not TLSv1.2 is enabled for this pool. Choosing the global setting means the value of the configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1_2"> "ssl!support_tls1_2"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__strict_verify*]
# Whether or not strict certificate verification should be performed. This will turn on checks to disallow server certificates that don't match the server name, are self-signed, expired, revoked, or have an unknown CA.
#
# [*tcp__nagle*]
