...
# Type:array, Details:{"name"=>{"description"=>"The name of the argument to be passed to the event handling program.", "type"=>"string"}, "value"=>{"description"=>"The value of the argument to be passed to the event handling program.", "type"=>"string"}, "description"=>{"description"=>"A description for the argument provided to the program.", "type"=>"string"}}
#
# [*program__program*]
# The program to run.
#
