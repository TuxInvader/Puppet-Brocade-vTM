...
# Whether or not the Fallback SCSV sent by TLS clients is honored by this virtual server. Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!honor_fallback_scsv"> "ssl!honor_fallback_scsv"</a> from the Global Settings section of the System tab will be enforced.
#
# [*aptimizer__enabled*]
...
# Type:array, Details:{"name"=>{"description"=>"The name of an Aptimizer acceleration profile.", "type"=>"string"}, "urls"=>{"description"=>"The application scopes which apply to the acceleration profile.", "type"=>"array", "uniqueItems"=>true, "items"=>{"type"=>"string"}}}
#
...
# The amount of memory, in bytes, that the virtual server should use to store data sent by the client. Larger values will use more memory, but will minimise the number of "read()" and "write()" system calls that the traffic manager must perform.
#
# [*connection__max_server_buffer*]
# The amount of memory, in bytes, that the virtual server should use to store data returned by the server.  Larger values will use more memory, but will minimise the number of "read()" and "write()" system calls that the traffic manager must perform.
#
...
# If specified, the traffic manager will use the value as the banner to send for server-first protocols such as POP, SMTP and IMAP. This allows rules to use the first part of the client data (such as the username) to select a pool.
#
# [*connection__timeout*]
...
#
# [*log__filename*]
# The name of the file in which to store the request logs. Appliances will ignore this. The filename can contain macros which will be expanded by the traffic manager to generate the full filename. 
#
# [*log__format*]
...
# Type:array, Details:{"issuer"=>{"description"=>"The name of an issuer (or DEFAULT for default OCSP settings).", "type"=>"string"}, "aia"=>{"description"=>"Whether the traffic manager should use AIA information contained in a client certificate to determine which OCSP responder to contact.", "type"=>"boolean"}, "nonce"=>{"description"=>"How to use the OCSP nonce extension, which protects against OCSP replay attacks. Some OCSP servers do not support nonces.", "type"=>"string", "enum"=>["off", "on", "strict"]}, "required"=>{"description"=>"Whether we should do an OCSP check for this issuer, and whether it is required or optional.", "type"=>"string", "enum"=>["none", "optional", "strict"]}, "responder_cert"=>{"description"=>"The expected responder certificate.", "type"=>"string"}, "signer"=>{"description"=>"The certificate with which to sign the request, if any.", "type"=>"string"}, "url"=>{"description"=>"Which OCSP responders this virtual server should use to verify client certificates.", "type"=>"string"}}
#
...
# Type:array, Details:{"host"=>{"description"=>"Host which this entry refers to.", "type"=>"string"}, "certificate"=>{"description"=>"The SSL server certificate for a particular destination site IP.", "type"=>"string"}}
#
...
#
# [*ssl__ssl_ciphers*]
# The SSL/TLS ciphers to allow for connections to this virtual server.  Leaving this empty will make the virtual server use the globally configured ciphers, see configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!ssl3_ciphers"> "ssl!ssl3_ciphers"</a> in the Global Settings section of the System tab.  See there for how to specify SSL/TLS ciphers.
#
# [*ssl__ssl_support_ssl2*]
# Whether or not SSLv2 is enabled for this virtual server.  Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_ssl2"> "ssl!support_ssl2"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_ssl3*]
# Whether or not SSLv3 is enabled for this virtual server.  Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_ssl3"> "ssl!support_ssl3"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1*]
# Whether or not TLSv1.0 is enabled for this virtual server. Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1"> "ssl!support_tls1"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1_1*]
# Whether or not TLSv1.1 is enabled for this virtual server. Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1.1"> "ssl!support_tls1.1"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__ssl_support_tls1_2*]
# Whether or not TLSv1.2 is enabled for this virtual server. Choosing the global setting means the value of configuration key <a href="?fold_open=SSL%20Configuration&section=Global%20Settings#a_ssl!support_tls1.2"> "ssl!support_tls1.2"</a> from the Global Settings section of the System tab will be enforced.
#
# [*ssl__trust_magic*]
