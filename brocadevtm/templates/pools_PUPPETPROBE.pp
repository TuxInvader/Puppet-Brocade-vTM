# === Define: brocadevtm::pools_PUPPETPROBE
#
...
define brocadevtm::pools_PUPPETPROBE (
  ...
  info ("Configuring pools_PUPPETPROBE ${name}")
  vtmrest { "pools/PUPPETPROBE/${name}":
    endpoint => "https://${ip}:${port}/api/tm/3.3/config/active",
    ensure => $ensure,
    username => $user,
    password => $pass,
    type => 'application/json',
    content => template('brocadevtm/pools_PUPPETPROBE.erb'),
    debug => 0,
  }
}
