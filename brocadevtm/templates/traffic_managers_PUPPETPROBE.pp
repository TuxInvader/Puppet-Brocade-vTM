# === Define: brocadevtm::traffic_managers_PUPPETPROBE
#
...
define brocadevtm::traffic_managers_PUPPETPROBE (
  ...
  info ("Configuring traffic_managers_PUPPETPROBE ${name}")
  vtmrest { "traffic_managers/PUPPETPROBE/${name}":
    endpoint => "https://${ip}:${port}/api/tm/3.3/config/active",
    ensure => $ensure,
    username => $user,
    password => $pass,
    type => 'application/json',
    content => template('brocadevtm/traffic_managers_PUPPETPROBE.erb'),
    debug => 0,
  }
}
